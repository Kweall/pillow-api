...
Реализован на C++ с использованием фреймворка Yandex Userver. Реализовано 12 API endpoints. Использовано in-memory хранилище (словари C++). Реализована обработка ошибок с правильными HTTP статус-кодами. Использованы DTO структуры для передачи данных (UserData, Property, Viewing). Архитектура с разделением на сервисы:
